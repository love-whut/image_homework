...
def get_params():
    params = {
        'weight': 'runs/train/xiaorong/r18-CascadedGroupAttention-MPDIoU/weights/best.pt',
        'cfg': 'ultralytics/cfg/models/rt-detr/rtdetr-CascadedGroupAttention.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/data/war/dataset/NWPU/NWPU_YOLO/images/val/000144.jpg', 'result')